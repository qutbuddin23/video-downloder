...
requirements = python3,kivy,sqlite3,openssl,certifi,requests,beautifulsoup4,typing_extensions,soupsieve,yt-dlp,pyjnius,pyaes

orientation = portrait
fullscreen = 0

# Android permissions
android.permissions = INTERNET,ACCESS_NETWORK_STATE,SYSTEM_ALERT_WINDOW,FOREGROUND_SERVICE,POST_NOTIFICATIONS,WAKE_LOCK,READ_MEDIA_VIDEO,READ_EXTERNAL_STORAGE,WRITE_EXTERNAL_STORAGE
